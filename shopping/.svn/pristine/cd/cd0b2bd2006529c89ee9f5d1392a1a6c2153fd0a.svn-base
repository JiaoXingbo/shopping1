						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes" style="width:1200px">
									<c:forEach items="${products }" var="product">
										<li style="width:300px">
											<a href="${pageContext.request.contextPath}/product/detail?proid=${product.proid}">
							...
							<ul class="am-pagination am-pagination-right" style="width:700px">
								<li><a href="${pageContext.request.contextPath}/product/list?typeid=${products.get(0).typeid }&nowPage=${nowPage-1}">&laquo;</a></li>
								<li class="am-active">${nowPage }</li>
								<li><a href="${pageContext.request.contextPath}/product/list?typeid=${products.get(0).typeid }&nowPage=${nowPage+1}">&raquo;</a></li>
							</ul>
