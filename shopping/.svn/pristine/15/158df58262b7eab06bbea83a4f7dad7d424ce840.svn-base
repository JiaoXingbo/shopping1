						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/address/update" method="post">
										<input type="hidden" name="orderid" value="${orderid }">
										<input type="hidden" name="addressid" value="${address.addressid }">
										<div class="am-form-group">
											<label for="user-name" class="am-form-label">收货人</label>
											<div class="am-form-content">
												<input type="text" id="user-name" name="consignee" value="${address.consignee }">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="user-phone" name="conphone" value="${address.conphone }" type="text">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												...
												<textarea id="user-addr" name="detailaddr" class="" rows="3" id="user-intro" value="${address.detailaddr }">${address.detailaddr }</textarea> 
