						...
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">
							...
							<ul class="am-pagination am-pagination-right" style="width:700px">
								<li><a href="${pageContext.request.contextPath}/product/search?keyWord=${keyWord }&nowPage=${nowPage-1}">&laquo;</a></li>
								<li class="am-active">${nowPage }</li>
								<li><a href="${pageContext.request.contextPath}/product/search?keyWord=${keyWord }&nowPage=${nowPage+1}">&raquo;</a></li>
							</ul>
