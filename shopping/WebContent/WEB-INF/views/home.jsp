...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
					...
					<div class="topMessage">
						<div class="menu-hd">
							...
							<c:if test="${! empty user }">
								<span>欢迎:  <img style="height: 25px;width: 25px;" src="${pageContext.request.contextPath}/static/touxiang/${user.userpicurl}">   ${user.username}</span>
								&nbsp&nbsp&nbsp
			...
			<div class="shopNav">
				<div class="slideall">
					...
					<div class="am-g am-g-fixed smallnav">
						<div class="am-u-sm-3">
							<a ><img src="${pageContext.request.contextPath}/static/images/navsmall.jpg" />
							...
							<div class="m-baseinfo">
								<c:if test="${empty user }">
									...
									<div class="member-logout">
										<a class="am-btn-warning btn" href="${pageContext.request.contextPath}/home/showLogin">登录</a>
										<a class="am-btn-warning btn" href="${pageContext.request.contextPath}/home/showRegister">注册</a>
									</div>
								</c:if>
								<c:if test="${!empty user }">
									<a >
										<img src="${pageContext.request.contextPath}/static/touxiang/${user.userpicurl}">
									</a>
									<em>
					...
					<div class="footer ">
						...
						<div class="footer-bd ">
							<p>
								...
								<a href="# ">联系我们</a>
								<a href="# ">网站地图</a>
								<em>© 2015-2025 Hengwang.com 版权所有. 更多模板 <a    title="模板之家">模板之家</a> - Collect from <a   title="网页模板" >网页模板</a></em>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="navCir">
			...
			<li><a ><i class="am-icon-shopping-basket"></i>购物车</a></li>	
			<li><a ><i class="am-icon-user"></i>我的</a></li>					
		</div>
		<!--菜单 -->
		<div class=tip>
			<div id="sidebar">
				<div id="wrap">
					...
					<div class="quick_toggle ">
						...
						<!--二维码 -->
						<li class="qtitem ">
							<a ><span class="mpbtn_qrcode "></span></a>
						...
						<li class="qtitem ">
							<a  class="return_top "><span class="top "></span></a>
						</li>
					</div>
